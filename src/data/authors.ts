...
export const authors: Author[] = [
  ...
  },
  {
    ...
    gallery: [
      { src: "/images/content/00eqLdyrpfZBRz5DKemobh4kQU.png", alt: "Federico Sendra delivering a keynote on Web3 product strategy." },
      ...
      { src: "/images/content/9X2GlCwcuQ6xnkjL24hYUhozU.png", alt: "Federico Sendra at an industry conference panel." },
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: "/images/content/ISwpOm131QIqCH8MFaadZ9zSvus.png", alt: "Juan Manuel Sobral reviewing smart contract code with the team." },
      { src: "/images/content/YsbdX3EJ9VDlsYSu4d9uLfVvKy4.png", alt: "Juan Manuel Sobral leading a workshop on smart contract security." },
