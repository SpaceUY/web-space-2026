---
metatitle: "A Few Thoughts on Decentralization in Web3"
...
cover: "/images/content/a-few-thoughts-on-decentralization/cover.png"
readTime: 4
takeaways:
...
However, by design or practice, blockchains consistently fall short of genuine decentralization. Consider Bitcoin's origins: Satoshi Nakamoto's identity remains unknown, potentially an individual, group, or organization. The [foundational white paper](https://bitcoin.org/bitcoin.pdf) itself lacked transparency. Despite enabling all users to validate transactions through mining, individuals frequently form organized pools controlling most transaction validation.
