...
**Shallow pool security assumptions.** Building a [lending protocol](/blockchain-development-services/industry/finance-and-fintech/lending-protocols) that reads price from a pool with $500k in TVL is an invitation to an oracle manipulation attack. Liquidity depth should be part of the security threat model from the start.
