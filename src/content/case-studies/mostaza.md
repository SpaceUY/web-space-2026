...
category: Web3
accent: purple
client: "Mostaza Financial Services"
industry: "Fintech"
year: 2024
duration: "6+ months"
team: "8 engineers"
...
heroImage: "/images/case-studies/mostaza/mostaza_.png"
summary: "Mostaza is a Colombian fintech building a bridge between traditional finance and Web3. SpaceDev ran a comprehensive Discovery Sprint to define the MVP strategy, then took on full product development — delivering a USDT wallet, virtual card, and yield-bearing investment feature designed for users who have never touched crypto."
objectives:
  - "Define the MVP scope through a thorough Discovery Sprint, covering product, technical, and operational dimensions."
  - "Build a simple, intuitive USDT wallet that handles the COP-to-USDT conversion transparently for end users."
  - "Integrate a virtual card linked to the wallet balance, usable online and in-store locally and internationally."
  - "Implement a yield-bearing savings feature using USDM (Mountain Protocol) to give users a stable, predictable return."
  - "Develop a back-office system for Mostaza's internal team to manage users and transactions."
deliverables:
  - "Discovery Sprint: product vision, architecture, and incremental implementation roadmap."
  - "React Native mobile app (iOS & Android) with USDT wallet, COP/USDT conversion, and savings goals."
  - "USDM investment feature offering 4–5% APY through Mountain Protocol integration."
  - "Virtual card functionality linked to wallet balance for local and international purchases."
  - "NestJS backend with MongoDB and PostgreSQL on AWS, structured for regulatory compliance and scalability."
  - "Back-office admin panel for transaction management, user oversight, and operational control."
...
There was also the regulatory and operational dimension. Handling COP-to-USDT conversions, managing a virtual card infrastructure, and integrating a yield-bearing stablecoin like USDM all required clear decisions about architecture, compliance, and risk — decisions that needed to be made deliberately, not improvised during development.
