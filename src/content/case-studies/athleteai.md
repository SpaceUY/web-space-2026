...
summary: "Athlete.AI is a mobile platform for basketball players, coaches, parents, and fans to capture game highlights, create reels, and share them across social media. SpaceDev built the iOS app from scratch in four months, delivering a production-ready product that was already being used at live tournaments across the USA before the partnership ended."
objectives:
  - Give basketball players a fast, simple tool to capture their best moments from games and training.
  - Enable players to create shareable highlight reels that attract the attention of coaches and teams.
  - Build a social layer so content can be shared within the app community and across external platforms.
  - Deliver a stable iOS build to the App Store within a four-month timeline.
deliverables:
  - "React Native app (Expo + GlueStack) for iOS with video capture, reel creation, and social sharing."
  - "Video processing and streaming infrastructure using Mux, with assets stored on AWS S3."
  - "Next.js backend services for user profiles, content management, and feed logic."
  - "App Store submission and production deployment, including QA sign-off."
