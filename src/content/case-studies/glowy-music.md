...
objectives:
  ...
  - "Build a backoffice admin panel for the Glowy team to manage users, events, news, and advertising."
  - "Align the product scope with the long-term vision of expanding across Latin America and into global markets."
  - "Create a technical foundation that supports rapid growth without requiring a full architectural rebuild."
deliverables:
  - "React Native mobile app (iOS & Android) with music discovery, artist profiles, and event listings."
  - "Backoffice admin panel built with Next.js for user management, event creation, news drafting, ad management, and push notifications."
  - "NestJS backend with PostgreSQL on AWS, structured for scalability."
  - "Product vision and MVP scope definition in collaboration with the Glowy founding team."
